...
static std::map<std::string,
                std::pair<std::string, std::string> > _create_encoding_map()
{
    ...
    result["ISO_IR 100"] = std::make_pair("ISO-IR-100", ""); // Latin alphabet 1
    result["ISO_IR 101"] = std::make_pair("ISO-IR-101", ""); // Latin alphabet 2
    result["ISO_IR 109"] = std::make_pair("ISO-IR-109", ""); // Latin alphabet 3
    result["ISO_IR 110"] = std::make_pair("ISO-IR-110", ""); // Latin alphabet 4
    ...
    result["ISO_IR 148"] = std::make_pair("ISO-IR-148", ""); // Latin alphabet 5
...
std::string convert_to_utf8_with_escape(
