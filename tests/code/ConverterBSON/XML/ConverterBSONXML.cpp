...
struct TestDataConversionBSONXML
{
    ...
    TestDataConversionBSONXML()
    {
        ...
        mongo::BSONObjBuilder value_builder;
        value_builder << "vr" << "PN";
        value_builder << "Value" << BSON_ARRAY(
        ...
        value_builder << "vr" << "SQ";
        value_builder << "Value"
                      << BSON_ARRAY(BSON("00100020" << subvalue_builder.obj()));
...
void
isEqual(mongo::BSONObj const & firstbson, mongo::BSONObj const & secondbson)
{
    for(mongo::BSONObj::iterator it = firstbson.begin(); it.more();)
    {
        ...
        if (element_bson.Obj().getField("Value").Array()[0].type() ==
...
void
create_dicomattribute_pn(boost::property_tree::ptree & nativetree,
                         std::string const & dicom_tag,
                         std::string const & dicom_keyword,
...
void
create_dicomattribute_sq(boost::property_tree::ptree & nativetree,
                         std::string const & dicom_tag,
                         std::string const & dicom_keyword,
...
struct TestDataConversionXMLBSON
{
    ...
    TestDataConversionXMLBSON()
    {
        ...
        std::vector<std::string> const valuesstringBinary =
                { "YXplcnR5dWlvcHFzZGZnaGprbG13eGN2Ym4xMjM0NTY" };

        boost::property_tree::ptree nativetree;

        create_dicomattribute(nativetree, "00080054", "AE",
                              "RetrieveAE​Title", valuesstring);
        create_dicomattribute(nativetree, "00101010", "AS",
                              "Patient​Age", valuesstring);
        create_dicomattribute(nativetree, "00209165", "AT",
                              "Dimension​Index​Pointer", valuesstring);
        create_dicomattribute(nativetree, "00080060", "CS",
                              "Modality", valuesstring);
        create_dicomattribute(nativetree, "00100030", "DA",
                              "Patient​Birth​Date", valuesstring);
        create_dicomattribute(nativetree, "00101030", "DS",
                              "Patient​Weight", valuesfloat64);
        create_dicomattribute(nativetree, "00189074", "DT",
                              "Frame​Acquisition​Date​Time", valuesstring);
        create_dicomattribute(nativetree, "00460044", "FD",
                              "Pupil​Size", valuesfloat64);
        create_dicomattribute(nativetree, "00089459", "FL",
                              "Recommended​Display​Frame​Rate​InFloat",
                              valuesfloat32);
        create_dicomattribute(nativetree, "00082122", "IS",
                              "Stage​Number", valuessint32);
        create_dicomattribute(nativetree, "00080070", "LO",
                              "Manufacturer", valuesstring);
        create_dicomattribute(nativetree, "001021b0", "LT",
                              "Additional​Patient​History", valuesstring);
        create_dicomattribute(nativetree, "00282000", "OB",
                              "ICC​Profile", valuesstringBinary,
                              dopamine::converterBSON::Tag_InlineBinary);
        create_dicomattribute(nativetree, "00640009", "OF",
                              "Vector​Grid​Data", valuesstringBinary,
                              dopamine::converterBSON::Tag_InlineBinary);
        create_dicomattribute(nativetree, "00660023", "OW",
                              "TrianglePointIndexList", valuesstringBinary,
                              dopamine::converterBSON::Tag_InlineBinary);
        ...
        create_dicomattribute_pn(nativetree, "00100010", "PatientName",
                                 valuespn);

        create_dicomattribute(nativetree, "00102160", "SH", "Ethnic​Group",
                              valuesstring);
        create_dicomattribute(nativetree, "00186020", "SL", "ReferencePixelX0",
                              valuessint32);
        ...
        attributeLO.put(dopamine::converterBSON::Attribute_Keyword,
                        "PatientID");
        attributeLO.add_child(dopamine::converterBSON::Tag_Value, value);
        std::vector<boost::property_tree::ptree> const valuessq =
                { attributeLO, attributeLO };
        create_dicomattribute_sq(nativetree, "00101002",
                                 "Other​Patient​IDs​Sequence", valuessq);

        create_dicomattribute(nativetree, "00189219", "SS", "TagAngleSecondAxis",
                              valuessint16);
        create_dicomattribute(nativetree, "00080081", "ST", "InstitutionAddress",
                              valuesstring);
        create_dicomattribute(nativetree, "00080013", "TM",
                              "Instance​Creation​Time", valuesstring);
        create_dicomattribute(nativetree, "00080016", "UI", "SOPClassUID",
                              valuesstring);
        create_dicomattribute(nativetree, "00081161", "UL", "SimpleFrameList",
                              valuesuint32);
        // UN
        create_dicomattribute(nativetree, "00081197", "US", "FailureReason",
                              valuesuint16);
        create_dicomattribute(nativetree, "00287fe0", "UT",
                              "Pixel​Data​ProviderURL", valuesstring);
