...
{
    auto tagmatch = research_pacs::TagMatch::New(DcmTagKey(0x0010, 0x0010));
...
{
    auto tagmatch = research_pacs::TagMatch::New(DcmTagKey(0x0008, 0x0010));
...
{
    auto tagmatch = research_pacs::TagMatch::New(DcmTagKey(0x0010, 0x0020));
